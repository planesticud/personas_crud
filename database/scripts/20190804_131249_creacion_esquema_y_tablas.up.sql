...
CREATE TABLE persona.grupo_sanguineo_persona (
	...
	CONSTRAINT uq_grupo_sanguineo_persona UNIQUE (persona_id)
...
CREATE TABLE persona.persona (
	...
	CONSTRAINT uq_ente UNIQUE (ente_id)
...
-- ddl-end --
COMMENT ON COLUMN persona.persona.ente_id IS 'Identificador de la tabla ente';
-- ddl-end --
COMMENT ON COLUMN persona.persona.foto_id IS 'Corresponde al id de la tabla documento';
-- ddl-end --
...
CREATE TABLE persona.persona_estado_civil (
	...
	CONSTRAINT uq_estado_civil_persona UNIQUE (estado_civil_id,persona_id)
...
-- ddl-end --
COMMENT ON COLUMN persona.persona_estado_civil.estado_civil_id IS 'Identificador foraneo a la tabla parametrica estado_civil.';
-- ddl-end --
COMMENT ON COLUMN persona.persona_estado_civil.persona_id IS 'Identificador de la tabla persona';
-- ddl-end --
...
-- ddl-end --
COMMENT ON COLUMN persona.persona_genero.genero_id IS 'Identificador de la tabla genero.';
-- ddl-end --
COMMENT ON COLUMN persona.persona_genero.persona_id IS 'Identificador de la tabla persona';
-- ddl-end --
...
CREATE TABLE persona.persona_grupo_etnico (
	id serial NOT NULL,
	grupo_etnico_id integer NOT NULL,
	persona_id integer NOT NULL,
	activo boolean NOT NULL,
	fecha_creacion timestamp NOT NULL DEFAULT now(),
	fecha_modificacion timestamp NOT NULL DEFAULT now(),
	CONSTRAINT pk_persona_grupo_etnico PRIMARY KEY (id),
	CONSTRAINT uq_grupo_etnico_persona UNIQUE (persona_id)
...
-- ddl-end --
COMMENT ON COLUMN persona.persona_grupo_etnico.grupo_etnico_id IS 'Identificador de la tbala grupo_etnico';
-- ddl-end --
COMMENT ON COLUMN persona.persona_grupo_etnico.persona_id IS 'Identificador de la tabla persona';
-- ddl-end --
...
CREATE TABLE persona.persona_perfil_profesional (
	id serial NOT NULL,
	perfil_profesional_id integer NOT NULL,
	persona_id integer NOT NULL,
	activo boolean NOT NULL,
	fecha_creacion timestamp NOT NULL DEFAULT now(),
	fecha_modificacion timestamp NOT NULL DEFAULT now(),
...
-- ddl-end --
COMMENT ON COLUMN persona.persona_perfil_profesional.perfil_profesional_id IS 'Identificador de la tabla perfil_profesional';
-- ddl-end --
COMMENT ON COLUMN persona.persona_perfil_profesional.persona_id IS 'Identificador de la tabla persona';
-- ddl-end --
...
CREATE TABLE persona.persona_tipo_discapacidad (
	...
	CONSTRAINT uq_discapacidad_persona UNIQUE (tipo_discapacidad_id,persona_id)
...
-- ddl-end --
COMMENT ON COLUMN persona.persona_tipo_discapacidad.tipo_discapacidad_id IS 'Identificador de la tabla tipo_discapacidad';
-- ddl-end --
COMMENT ON COLUMN persona.persona_tipo_discapacidad.persona_id IS 'Identificador de la tabla persona';
-- ddl-end --
...
CREATE TABLE persona.relacion_personas (
	id serial NOT NULL,
	persona_principal_id integer NOT NULL,
	persona_relacionada_id integer NOT NULL,
	tipo_relacion_personas_id integer NOT NULL,
	activo boolean NOT NULL,
	fecha_creacion timestamp NOT NULL DEFAULT now(),
	fecha_modificacion timestamp NOT NULL DEFAULT now(),
	CONSTRAINT pk_relacion_personas PRIMARY KEY (id),
	CONSTRAINT uq_relacion_personas UNIQUE (persona_principal_id,persona_relacionada_id,tipo_relacion_personas_id)
...
-- ddl-end --
COMMENT ON COLUMN persona.relacion_personas.persona_principal_id IS 'identificador de la tabla persona, que indica la persona a la que se le indica la relacion';
-- ddl-end --
COMMENT ON COLUMN persona.relacion_personas.persona_relacionada_id IS 'identificador de la tabla persona, que indica la persona que es relacionada';
-- ddl-end --
...
ALTER TABLE persona.grupo_sanguineo_persona ADD CONSTRAINT fk_grupo_sanguineo_persona_persona FOREIGN KEY (persona_id)
...
ALTER TABLE persona.persona_estado_civil ADD CONSTRAINT fk_persona_estado_civil_persona FOREIGN KEY (persona_id)
REFERENCES persona.persona (id) MATCH FULL
...
ALTER TABLE persona.persona_estado_civil ADD CONSTRAINT fk_persona_estado_civil_estado_civil FOREIGN KEY (estado_civil_id)
...
ALTER TABLE persona.persona_genero ADD CONSTRAINT fk_persona_genero_persona FOREIGN KEY (persona_id)
REFERENCES persona.persona (id) MATCH FULL
ON DELETE NO ACTION ON UPDATE NO ACTION;
-- ddl-end --
...
ALTER TABLE persona.persona_genero ADD CONSTRAINT fk_persona_genero_genero FOREIGN KEY (genero_id)
...
ALTER TABLE persona.persona_grupo_etnico ADD CONSTRAINT fk_persona_grupo_etnico_grupo_etnico FOREIGN KEY (grupo_etnico_id)
...
ALTER TABLE persona.persona_grupo_etnico ADD CONSTRAINT fk_persona_grupo_etnico_persona FOREIGN KEY (persona_id)
REFERENCES persona.persona (id) MATCH FULL
ON DELETE NO ACTION ON UPDATE NO ACTION;
-- ddl-end --
...
ALTER TABLE persona.persona_perfil_profesional ADD CONSTRAINT fk_persona_perfil_profesional_perfil_profesional FOREIGN KEY (perfil_profesional_id)
...
ALTER TABLE persona.persona_perfil_profesional ADD CONSTRAINT fk_persona_perfil_profesional_persona FOREIGN KEY (persona_id)
REFERENCES persona.persona (id) MATCH FULL
ON DELETE NO ACTION ON UPDATE NO ACTION;
-- ddl-end --
...
ALTER TABLE persona.persona_tipo_discapacidad ADD CONSTRAINT fk_persona_tipo_discapacidad_persona FOREIGN KEY (persona_id)
REFERENCES persona.persona (id) MATCH FULL
ON DELETE NO ACTION ON UPDATE NO ACTION;
-- ddl-end --
...
ALTER TABLE persona.persona_tipo_discapacidad ADD CONSTRAINT fk_persona_tipo_discapacidad_tipo_discapacidad FOREIGN KEY (tipo_discapacidad_id)
...
ALTER TABLE persona.relacion_personas ADD CONSTRAINT fk_relacion_personas_persona_principal FOREIGN KEY (persona_principal_id)
REFERENCES persona.persona (id) MATCH FULL
ON DELETE NO ACTION ON UPDATE NO ACTION;
-- ddl-end --
...
ALTER TABLE persona.relacion_personas ADD CONSTRAINT fk_relacion_personas_persona_relacionada FOREIGN KEY (persona_relacionada_id)
REFERENCES persona.persona (id) MATCH FULL
ON DELETE NO ACTION ON UPDATE NO ACTION;
-- ddl-end --
...
ALTER TABLE persona.relacion_personas ADD CONSTRAINT fk_relacion_personas_tipo_relacion_personas FOREIGN KEY (tipo_relacion_personas_id)
